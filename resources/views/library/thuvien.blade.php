...
<link rel="icon" href="{{asset("public/assets/favicon/favicon.png")}}" type="image/x-icon">
<link rel="shortcut icon" href="{{asset("public/assets/favicon/favicon.png")}}" type="image/x-icon">
...
<link id="color" rel="stylesheet" href="{{asset("public/assets/css/color-1.css")}}" >
<!-- Responsive css-->
